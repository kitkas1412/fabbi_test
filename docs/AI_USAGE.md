...
| Frontend auth/query/session/Tag source and tests | Query-key/session/Tag design and implementation assistance | Candidate review remains required | Unit tests 13/13, ESLint, production build, and Playwright 5/5 pass |
